...
americas_fit <- linear_reg() %>%
  set_engine("lm") %>%
  fit(life_ladder ~ life_expectancy_std + social_support_std + gdp_2013_std, data = (filter(test_data, continent == "Americas")))
tidy(americas_fit)
...
europe_fit <- linear_reg() %>%
  set_engine("lm") %>%
  fit(life_ladder ~ life_expectancy_std + social_support_std + gdp_2013_std, data = (filter(test_data, continent == "Europe")))
tidy(europe_fit)
...
africa_fit <- linear_reg() %>%
  set_engine("lm") %>%
  fit(life_ladder ~ life_expectancy_std + social_support_std + gdp_2013_std, data = (filter(test_data, continent == "Africa")))
...
asia_fit <- linear_reg() %>%
  set_engine("lm") %>%
  fit(life_ladder ~ life_expectancy_std + social_support_std + gdp_2013_std, data = (filter(test_data, continent == "Asia")))
